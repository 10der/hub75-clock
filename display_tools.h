...
class DisplayTools : public Component {
 public:
  ...
  struct AlertMessage {
    ...
    std::string sound{"18"};    // просто рядок-ідентифікатор
    uint16_t repeat{1};
    ScrollingState scroll;
  };
  ...
  void set_temperature_progress(const std::vector<int> &progress) {
    this->temperature_progress_ = progress;
  }
  const std::vector<int> &get_temperature_progress() const {
    return this->temperature_progress_;
  }
  ...
  // ======================================================================
  void addApp(std::string name, std::string body = "", std::string color = "FFFFFF",
              uint16_t duration = 2, std::string icon = "", std::string icon_color = "FFFFFF",
              std::vector<ColoredWord> text_parts = {}, std::vector<DrawObject> draw_objects = {});
  ...
  // ======================================================================
  void addAlert(std::string text, std::string color, std::string icon,
                std::string icon_color, std::string sound, uint16_t repeat);
  bool hasAlert() const;
  ...
  bool drawScrollingTextWithIcon(Display &it,
  ...
  std::vector<DisplayTools::ColoredWord> make_colored_words(
